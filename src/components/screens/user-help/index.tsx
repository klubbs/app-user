    ...
    <Wrapper>
      <ContainerScroll>
        <MenuItem
          ...
          cb={() =>
            Linking.openURL(
              'https://enshrined-bubbler-645.notion.site/Klubbs-cf170a68e1254a9a97434a0f7b1a7541',
            )
          }
        />
        ...
        <MenuItem
          ...
          icon="mail"
          cb={() =>
            Linking.openURL('mailto:marketing@klubbs.com.br?subject=Oi, Klubbs tenho uma sugestão!')
          }
        />
        <MenuItem
          key={'2'}
          ...
          cb={() =>
            Linking.openURL(
              'https://enshrined-bubbler-645.notion.site/Termos-e-condi-es-47a39b695c174d059c49e49e6b657848',
            )
          }
        />
        <MenuItem
          ...
          cb={() =>
            Linking.openURL(
              'https://enshrined-bubbler-645.notion.site/Privacy-Policy-klubbs-4be747dae70a451d805540db6fb24957',
            )
          }
        />
        {user && (
