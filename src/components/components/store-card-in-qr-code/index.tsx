...
export const StoreCardInQrCode: React.FC<IWalletCouponsResponseOfferData & PressableProps> = (props) => {
  ...
  return (
    ...
    >
      ...
      {
        props.store_image &&
        <EstablishmentImage source={{ uri: `https://klubbs-establishment.s3.amazonaws.com/${props.store_image}` }} />
      }
